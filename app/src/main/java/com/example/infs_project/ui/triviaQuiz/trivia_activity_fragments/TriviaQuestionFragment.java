...
public class TriviaQuestionFragment extends Fragment {
    ...
    private void setUpTrivia(ArrayList<String> facts) {
        String[] falseFacts = {
            "An average ear of corn has odd number of rows.",
            "Only orange carrots exist.",
            "Raw eels can be consumed directly.",
            "The classic fortune cookie first originated in Hunan, China.",
            "Cucumbers were first grown in Western Australia. ",
            "Watermelons have less water content than radishes.",
            "Apples do not float in water.",
            ...
            "Twinkies were first released in 1937.",
            ...
            "Adding salt to water changes the boiling point, cooking food faster.",
            "Low fat foods are always better for you.",
            "Sugar was once widely used as a form of currency.",
            "Basil is the most popular spice in the world.",
            "Hummus is made from beans.",
            "There are 40 flavours of jelly beans.",
            "China exports the most food in the world.",
            "McDonalds was founded in 1950.",
            "The blue M&M was introduced in 1990.",
            "Seaweed is not high in fibre.",
            ...
            "Almonds grow underground.",
            "Yams and sweet potatoes are the same.",
            "Searing a steak seals in its juices.",
            "Decaf coffee has no caffeine in it.",
