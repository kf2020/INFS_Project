...
public class GetAllRecipesAsyncTask extends AsyncTask<Integer, Integer, ArrayList<Recipe>> {
    ...
    private GetAllRecipesAsyncDelegate delegate;
    ...
    public void setDelegate(GetAllRecipesAsyncDelegate delegate) {
